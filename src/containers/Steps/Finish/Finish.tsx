    ...
    <Portlet>
      <div className={styleClasses["finish"]}>
        <div className={styleClasses["finish__content"]}>
          ...
          <p className={styleClasses["finish__text"]}>Your reservation summary is as shown below. You can use the links below to update your reservation record or make a new reservation.</p>
        ...
        <ReservationDetails type="boxes" show={["checkin", "checkout", "adults", "children", "room", "view", "totals"]} />
      </div>
    </Portlet>
  );
};
