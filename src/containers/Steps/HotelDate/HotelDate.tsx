...
const HotelDate: React.FC<TypeReservationStep> = (props: TypeReservationStep) => {
  ...
  const [checkinValidators, setCheckinValidators] = useState<TypeValidator[]>([[validatorjs.isDate], [validatorjs.isAfter]]);
  const [checkoutValidators, setCheckoutValidators] = useState<TypeValidator[]>([[validatorjs.isDate], [validatorjs.isAfter, afterTwoDays]]);
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <div className={formClasses["form__wide-row"]}>
          <Select
            ...
            options={hotels ? hotels.names.map((hotel: any) => ({ label: hotel.hotel_name, value: hotel.id })) : []}
