  ...
  return (
    <>
      ...
      <main className={"container"}>
        <Steps>
          <StepsIndicator imgUrl={iconCalendar} title="Hotel &amp; Date" index={0} stepChangeHandler={stepChangeHandler} />
          <StepsIndicator imgUrl={iconBed} title="Room type &amp; View" index={1} stepChangeHandler={stepChangeHandler} />
          <StepsIndicator imgUrl={iconCreditCard} title="Preview &amp; Payment" index={2} stepChangeHandler={stepChangeHandler} />
        </Steps>
