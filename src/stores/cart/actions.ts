import { logger, getTwoDatesDiff, getRoomDetails, getStoredValue, clearStoredValues, getTotals } from "../../lib/scripts/utils";
...
export const newReservation = (cart: TypeCartDetails["cart"], hotelsDetails: TypeHotelDetails[], inputs: TypeInputs) => {
