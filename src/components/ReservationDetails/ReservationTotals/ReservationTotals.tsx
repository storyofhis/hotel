    ...
    <li className={styleClasses["reservation-details__totals"]}>
      ...
      {coupon.code && (
        <div className={styleClasses["reservation-details__totals__item"]}>
          ...
          <span className={styleClasses["reservation-details__totals__value"]}>-{discountAmount.toFixed(2)} TL</span>
        </div>
      )}
      <div className={styleClasses["reservation-details__totals__total"]}>
        ...
        <span className={styleClasses["reservation-details__totals__value"]}>{(totals.final - discountAmount).toFixed(2)} TL</span>
      </div>
    </li>
  );
};
